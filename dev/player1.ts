...
class player1 extends GameObject {
    ...
    onKeyPress(e:KeyboardEvent) {
        if (e.keyCode == 87) this.up = 1
        if (e.keyCode == 83) this.down = 1
        if (e.keyCode == 65) this.left = 1
        if (e.keyCode == 68) this.right = 1
    }

    onKeyRelease(e:KeyboardEvent) {
        if (e.keyCode == 87) this.up = 0
        if (e.keyCode == 83) this.down = 0
        if (e.keyCode == 65) this.left = 0
        if (e.keyCode == 68) this.right = 0
    }
}